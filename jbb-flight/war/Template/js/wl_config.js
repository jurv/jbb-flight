...
if($.fn.wl_Chart) $.fn.wl_Chart.defaults = {
	...
	colors: ['#53a5ff', '#f0b7b7', '#b5f0f0', '#e8e8b3', '#efb7ef', '#bbb6f0'],
	flot: {},
...
if($.fn.wl_Editor) $.fn.wl_Editor.defaults = {
	css: 'http://capseo.com/ui/templates/Default/css/light/editor.css',
...
if($.fn.wl_Fileexplorer) $.fn.wl_Fileexplorer.defaults = {
	url: 'http://sd-21828.dedibox.fr/modules/fileexplorer/connector.php',
	toolbar: [
		['back', 'reload', 'open', 'select', 'quicklook', 'info', 'rename', 'copy', 'cut', 'paste', 'rm', 'mkdir', 'mkfile', 'upload', 'duplicate', 'edit', 'archive', 'extract', 'resize', 'icons', 'list']
	]
};
...
if($.fn.wl_Form) $.fn.wl_Form.defaults = {
	...
	text: {
       ...
       send: 'Saving...',
       sendagain: 'Would you like to send again?',
       success: 'form sent!',
